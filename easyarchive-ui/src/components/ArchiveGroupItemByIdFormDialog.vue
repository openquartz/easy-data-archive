...
const title = computed(() =>
  props.mode === "create" ? t("archiveGroup.item.idCreateTitle") : t("archiveGroup.item.idEditTitle")
);
  ...
  <div v-if="visible" class="modal-backdrop" @click.self="emit('close')">
    <section class="modal-card">
      ...
      <form class="form-grid" @submit.prevent="handleSubmit">
        ...
        <label>{{ t("archiveGroup.item.startId") }}<input v-model="form.startId" :disabled="submitting" /></label>
        <label>{{ t("archiveGroup.item.endId") }}<input v-model="form.endId" :disabled="submitting" /></label>
        <label>{{ t("archiveGroup.item.stepCount") }}<input v-model.number="form.stepCount" type="number" :disabled="submitting" /></label>
        <label>{{ t("archiveGroup.item.stepRounds") }}<input v-model.number="form.stepRounds" type="number" :disabled="submitting" /></label>
