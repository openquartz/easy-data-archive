...
public class Environment {
    ...
    private final ThreadLocal<Map<String, Object>> localContextThreadLocal = new ThreadLocal<>();
    ...
    public Object getLocalContextParam(String key) {
        Map<String, Object> localContext = localContextThreadLocal.get();
    ...
    public Map<String, Object> getLocalContextParam(){
